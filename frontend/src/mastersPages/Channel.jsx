  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (msg.includes("duplicate") || msg.includes("E11000")) {
        setError("This channel name already exists");
      } else {
        setError(msg);
      }
    } finally {
          ...
          {filtered.length === 0 && (
            <div className="col-span-full flex flex-col items-center justify-center py-20 text-slate-400">
              ...
              <p className="text-sm mt-1">
                {search ? "Try a different search term" : 'Click "+ Add Channel" to get started'}
              </p>
            </div>
          )}
        </div>
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white w-[440px] rounded-2xl p-6 shadow-xl">
            ...
            <input
              ...
              placeholder="e.g. Direct Sales, Online, Distributor..."
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white w-[400px] rounded-2xl p-6 shadow-xl">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-lg font-semibold text-slate-800">Delete Channel</h2>
            </div>
